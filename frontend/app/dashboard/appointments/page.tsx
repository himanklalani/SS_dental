                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div className="flex gap-3 pt-4">
                                ...
                                <div className="flex-[2] flex flex-col gap-2">
                                    ...
                                    <button onClick={() => handleCompleteFlow('review')} disabled={isFollowUpNeeded && (!followUpData.date || !followUpData.time)} className="w-full py-2.5 bg-emerald-500 text-white rounded font-bold hover:bg-emerald-600 transition-colors disabled:opacity-50 flex items-center justify-center gap-2 text-sm shadow-lg shadow-emerald-900/20"><Star size={14} /><span>Done &amp; Send Review Link (+ Follow-up)</span></button>
                                    <button onClick={() => handleCompleteFlow('review_no_followup')} disabled={isFollowUpNeeded && (!followUpData.date || !followUpData.time)} className="w-full py-2.5 bg-teal-500 text-white rounded font-bold hover:bg-teal-600 transition-colors disabled:opacity-50 flex items-center justify-center gap-2 text-sm"><Star size={14} /><span>Done &amp; Send Review Link (No Follow-up)</span></button>
